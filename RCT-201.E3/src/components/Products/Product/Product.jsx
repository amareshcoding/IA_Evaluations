...
//     setShow(false);
//     // console.log(id)
//     dispatch(addItemToCart({productId:id,count:1,id:id}))
//   }
...
//   const handleUpdate = (id,typ) => {
//     dispatch(updateCartItem(id,typ))
//   }
...
//   })
//   return (
//     <div data-cy={`product-${id}`} style={{border: "1px solid", padding:"20px", borderRadius:"10px"}}>
//       <h3 data-cy="product-name">{product.name}</h3>
//       <h6 data-cy="product-description">{product.description}</h6>
//       {show ?
//       <button data-cy="product-add-item-to-cart-button" onClick={() => handleAdd(id)}>Add to Cart</button>
//       :
//       <div>
//         <button data-cy="product-increment-cart-item-count-button" onClick={() => handleUpdate(id,"inc",count)}>+</button>
//         <span data-cy="product-count">{count}</span>
//         <button data-cy="product-decrement-cart-item-count-button" onClick={() => handleUpdate(id,"dec",count)}>-</button>
//         <button data-cy="product-remove-cart-item-button" onClick={() => handleRemove(id)}>Remove from Cart</button>
//       </div>
//       }
//     </div>
//   );
